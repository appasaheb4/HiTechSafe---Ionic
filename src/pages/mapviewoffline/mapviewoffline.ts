...
//@IonicPage()
@Component({
  selector: 'page-mapviewoffline',
  templateUrl: 'mapviewoffline.html',
})
export class MapviewofflinePage {
...
this.http.post<mapView>('http://demo.winwaytechnology.in/ionicapp/index.php/MapViewAll/getLagAndLat', JSON.stringify(data), {  
    headers: headersNew         
  })  
.subscribe(res => {          
