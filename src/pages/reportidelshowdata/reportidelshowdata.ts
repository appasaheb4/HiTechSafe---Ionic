...
//@IonicPage()
@Component({
  selector: 'page-reportidelshowdata',
  templateUrl: 'reportidelshowdata.html',
})
export class ReportidelshowdataPage {
...
letterObj = {
   ...
   data = {vehicleName:"",startDate:"",endDate:"",minMin:"",maxMin:""};
...
this.data.minMin = navParams.get('param3');
this.data.maxMin = navParams.get('param4');

this.loadData(this.data.vehicleName,this.data.startDate,this.data.endDate,this.data.minMin,this.data.maxMin);   
}  
...
loadData(vehicleName,startDate,endDate,minDate,maxDate){
...
this.http.post<summaryData>('http://demo.winwaytechnology.in/ionicapp/index.php/ReportIdel/getIdelReport', JSON.stringify(data), {  
    headers: headersNew            
  })  
.subscribe(res => {                
console.log(res);         
